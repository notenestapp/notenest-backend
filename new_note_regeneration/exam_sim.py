...
def run_ocr_and_chunk(image):
    ...
    past_questions = ocr(image)[1]#This is the extracted text from the past question
...
def main(image, content, no_of_questions, type_of_questions):
    try:
        model = "gemini"
